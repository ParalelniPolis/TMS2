...
prosím kontaktuj správce stránek na <a href="'.ROOT.'/'.$language.'/contact">'.ROOT.'/'.$language.'/contact</a><br/>',
				'en' => 'Hello!<br/>
<br/>
We registered request about password change on the page <a href="'.ROOT.'/'.$language.'">'.ROOT.'</a>.<br/>
<br/>
...
please contact our webmaster on this page: <a href="'.ROOT.'/'.$language.'/contact">'.ROOT.'/'.$language.'/contact</a><br/>'
			...
			if (isset($_SESSION['username']))
				$loggedUser = $_SESSION['username']; else $loggedUser = "we dont know :(";
