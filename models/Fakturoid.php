...
class Fakturoid {
	...
	public function get_users($options = null) {
		return $this->get('/users.json'.$this->convert_options($options, ['page']));
	}
	
	/* Invoice */
	
	public function get_invoices($options = null) {
		return $this->get("/invoices.json".$this->convert_options($options, [
				'subject_id',
				'since',
				'updated_since',
				'page',
	...
	public function get_regular_invoices($options = null) {
		return $this->get('/invoices/regular.json'.$this->convert_options($options, [
				'subject_id',
				'since',
				'updated_since',
				'page',
	...
	public function get_proforma_invoices($options = null) {
		return $this->get('/invoices/proforma.json'.$this->convert_options($options, [
				'subject_id',
				'since',
				'updated_since',
				'page',
	...
	public function search_invoices($options = null) {
		return $this->get("/invoices/search.json".$this->convert_options($options, ['query', 'page']));
	}
	...
	public function fire_invoice($id, $event, $options = []) {
		return $this->post("/invoices/$id/fire.json", array_merge(['event' => $event], $options));
	}
	...
	public function get_expenses($options = null) {
		return $this->get("/expenses.json".$this->convert_options($options, [
				'subject_id',
				'since',
				'updated_since',
				'page',
	...
	public function search_expenses($options = null) {
		return $this->get("/expenses/search.json".$this->convert_options($options, ['query', 'page']));
	}
	...
	public function fire_expense($id, $event, $options = []) {
		return $this->post("/expenses/$id/fire.json", array_merge(['event' => $event], $options));
	}
	...
	public function get_subjects($options = null) {
		return $this->get('/subjects.json'.$this->convert_options($options, [
				'since',
				'updated_since',
				'page',
				'custom_id'
	...
	public function search_subjects($options = null) {
		return $this->get('/subjects/search.json'.$this->convert_options($options, ['query']));
	}
	
	/* Generator */
	
	public function get_generators($options = null) {
		return $this->get('/generators.json'.$this->convert_options($options, [
				'subject_id',
				'since',
				'updated_since'
			]));
	...
	public function get_recurring_generators($options = null) {
		return $this->get('/generators/recurring.json'.$this->convert_options($options, [
				'subject_id',
				'since',
				'updated_since'
			]));
	...
	public function get_template_generators($options = null) {
		return $this->get('/generators/template.json'.$this->convert_options($options, [
				'subject_id',
				'since',
				'updated_since'
			]));
	...
	public function get_events($options = null) {
		return $this->get('/events.json'.$this->convert_options($options, ['subject_id', 'since', 'page']));
	}
	
	public function get_paid_events($options = null) {
		return $this->get('/events/paid.json'.$this->convert_options($options, ['subject_id', 'since', 'page']));
	}
	
	public function get_todos($options = null) {
		return $this->get('/todos.json'.$this->convert_options($options, ['subject_id', 'since', 'page']));
	}
